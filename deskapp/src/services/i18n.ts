...
export const TRANSLATIONS = {
  vi: {
    ...
    theme_mode_desc: 'Tự động theo hệ thống hoặc chọn sáng/tối',
    theme_system: 'Theo hệ thống',
    theme_light: 'Sáng',
    theme_dark: 'Tối',
    theme_switch_light: 'Chuyển sang chế độ sáng',
    theme_switch_dark: 'Chuyển sang chế độ tối',
    language: 'Ngôn ngữ',
  ...
  en: {
    ...
    theme_mode_desc: 'Follow the system or choose light/dark',
    theme_system: 'System',
    theme_light: 'Light',
    theme_dark: 'Dark',
