// Language & Currency Service for MDaily
...
export const TRANSLATIONS = {
  vi: {
    ...
    // Add Expense
    add_photo_optional: 'Thêm ảnh (tùy chọn)',
    processing: 'Đang xử lý...',
    take_photo_sub: 'Chụp hoặc chọn ảnh hoá đơn / đồ vật',
    ...
    auto_extract_desc: 'Trích xuất hoá đơn & tên đồ vật khi chụp ảnh',
    auto_extract_req: 'Cần thiết bị hỗ trợ Apple Intelligence',
    ai_chat: 'AI Chat',
    ai_chat_desc: 'Trò chuyện với MDaily AI trợ lý tài chính',
    ...
    delete_all_desc: 'Xoá tất cả chi tiêu đã lưu',
    ...
    sync_modes: 'Tùy chọn đồng bộ',
    sync_two_way: 'Đồng bộ 2 chiều (Hợp nhất)',
    sync_two_way_desc: 'Hợp nhất chi tiêu & danh mục giữa 2 thiết bị',
    sync_push: 'Gửi lên máy tính',
    sync_push_desc: 'Gửi toàn bộ dữ liệu trên điện thoại sang máy tính',
    sync_pull: 'Tải về điện thoại',
    sync_pull_desc: 'Tải toàn bộ dữ liệu từ máy tính về điện thoại',
    ...
    last_sync: 'Lần đồng bộ gần nhất',
    choose_qr_image: 'Chọn ảnh mã QR',
    camera_permission_error: 'Không thể mở camera. Vui lòng cấp quyền hoặc nhập IP thủ công.',
    qr_not_detected: 'Không nhận diện được mã QR trong ảnh. Vui lòng thử lại.',
    paired_with: 'Đã liên kết với',
  ...
  en: {
    ...
    // Dashboard
    no_expenses: 'No expenses yet. Tap "Add" to create one.',
    ...
    take_photo_sub: 'Capture or select receipt/item photo',
    ...
    auto_extract_desc: 'Extract receipts & items when taking photos',
    auto_extract_req: 'Requires Apple Intelligence supported device',
    ai_chat: 'AI Chat',
    ai_chat_desc: 'Chat with MDaily AI financial assistant',
    ...
    // Wi-Fi Sync
    wifi_sync: 'Wi-Fi Sync',
    wifi_sync_desc: 'Pair & sync data with MDaily Desktop over local Wi-Fi',
    scan_qr: 'Scan QR Code',
    scan_qr_desc: 'Point camera at the QR code displayed on MDaily Desktop',
    sync_connected: 'Connected',
    sync_modes: 'Sync Options',
    sync_two_way: '2-Way Merge (Smart)',
    sync_two_way_desc: 'Merge expenses & categories across both devices',
    sync_push: 'Push to Desktop',
    sync_push_desc: 'Upload all phone expenses to desktop',
    sync_pull: 'Pull to Phone',
    sync_pull_desc: 'Download all desktop expenses to phone',
    sync_now: 'Sync Now',
    syncing: 'Syncing...',
    ...
    choose_qr_image: 'Choose QR Image',
    camera_permission_error: 'Camera access denied. Please allow permissions or enter IP manually.',
    qr_not_detected: 'No QR code found in the image. Please try again.',
